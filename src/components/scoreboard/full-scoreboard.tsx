  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 xl:gap-12">
        <PenaltiesDisplay teamDisplayType="Local" teamName={state.homeTeamName} penalties={state.penalties.home} />
        <PenaltiesDisplay teamDisplayType="Visitante" teamName={state.awayTeamName} penalties={state.penalties.away} />
      </div>
    </div>
  );
}
